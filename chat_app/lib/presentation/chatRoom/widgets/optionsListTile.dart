      ...
      body: Column(
        children: [kHeight15,
          Row(
            ...
            children: [
              CircleAvatar(backgroundColor:  Color(0xffB347EA),
                radius: 22.h,child: CircleAvatar(radius: 20.h,backgroundColor: backgroundColor,),
              ),
              Spacer(),
              Text(
                "Name is s ",
          ...
          Row(
            ...
            children: [
              buttons(
                  ...
                  width: 120.w,
                  widget: Text("Full access",style: TextStyle(color: textColor,fontSize: 15.sp),)),
              Spacer(),
              buttons(
                  height: 40.h,
                  color: Colors.grey,
                  width: 140.w,
                  widget: Text("Regal Acess",style: TextStyle(color: textColor,fontSize: 15.sp),)),
              Spacer(),
              buttons(
                  height:40.h,
                  color: Colors.orange,
                  ...
                  widget: buttons(
                      ...
                      width: 38.h,
                      widget: Icon(Icons.delete,color: Colors.orange,)))
            ],
          ),kHeight15
        ],
      ),
