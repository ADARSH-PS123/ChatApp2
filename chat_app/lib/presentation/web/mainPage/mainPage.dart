  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      floatingActionButton: Row(mainAxisAlignment: MainAxisAlignment.spaceAround,
        children: [CustomTextField(hintText: "text here", isSuffixWidget: true, padding: 12.h, width: (size.width-300)/2)],),
      body: Row(
        children: [
          SingleChildScrollView(
            child: ConstrainedBox(
              ...
              minWidth: 300),
              child: Padding(
                padding:  EdgeInsets.only(left: size.width*.01,top: size.height*.01,right: size.width*.01),
                child: Column(
                  children: [
                    ...
                    ListView(controller: ScrollController(),
                      shrinkWrap: true,
                      children: List.generate(40, (index) => ScreenListTile()),
                    )
                  ],
                ),
              ),
          ...
          Expanded(
            child: Column(
              children: [
                Container(color: Colors.blue,child:   Row(mainAxisAlignment: MainAxisAlignment.center,
                      children: [kWidth15,
                        CircleAvatar(
                          radius: 22.r,
                        ),Spacer(),
